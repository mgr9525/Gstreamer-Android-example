...
static void check_initialization_complete (CustomData *data) {
  JNIEnv *env = get_jni_env ();
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "check_initialization_complete init:%d , wind:%d , loop:%d",data->initialized,data->native_window, data->main_loop);
  if (!data->initialized && data->native_window && data->main_loop) {
    ...
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "check_initialization_complete1");
...
static void *app_function (void *userdata) {
  ...
  GST_DEBUG ("Creating pipeline in CustomData at %p", data);
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "app_function 1");
  ...
  if (error) {
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "app_function Unable to build pipeline: %s", error->message);
    ...
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "app_function 2");
  /* Disable subtitles */
  ...
  g_source_unref (timeout_source);
    ...
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "app_function 3");
  ...
  data->main_loop = NULL;
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "app_function 4");
...
static void gst_native_init (JNIEnv* env, jobject thiz) {
  ...
  pthread_create (&gst_app_thread, NULL, &app_function, data);
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "gst_native_init pthread_create");
}
...
static jboolean gst_native_class_init (JNIEnv* env, jclass klass) {
  ...
  if (!custom_data_field_id || !set_message_method_id || !on_gstreamer_initialized_method_id ||
     ...
     */
    __android_log_print (ANDROID_LOG_ERROR, "ruis-tutorial", "The calling class does not implement all necessary interface methods");
    return JNI_FALSE;
  }
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "gst_native_class_init complite");
  return JNI_TRUE;
}
...
static void gst_native_surface_init (JNIEnv *env, jobject thiz, jobject surface) {
  ...
  if (data->native_window) {
    __android_log_print (ANDROID_LOG_INFO, "ruis-tutorial", "gst_native_surface_init data->native_window");
